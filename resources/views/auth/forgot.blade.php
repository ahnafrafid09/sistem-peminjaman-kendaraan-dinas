            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <!-- Ganti bg-password-image dengan logo -->
                            <div class="col-lg-6 d-none d-lg-flex align-items-center justify-content-center bg-white">
                                <img src="{{ asset('img/7197526.jpg') }}" alt="Logo" class="img-fluid" style="max-width: 80%;">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="{{ route('auth.register') }}">Buat Akunn!</a>
                                    </div>
                                    <div class="text-center">
