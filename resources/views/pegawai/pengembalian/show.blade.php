        ...
        <div class="p-4">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" name="tanggal_pengembalian" id="tanggal_pengembalian" class="form-control"
                        value="{{ $pengembalian->peminjaman->tanggal_pengembalian->format('Y-m-d') }}" disabled>
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="time" name="jam_pengembalian" id="jam_pengembalian" class="form-control"
                                value="{{ $pengembalian->peminjaman->jam_pengembalian }}" disabled>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" id="kepemilikan_sim" class="form-control"
                        value="{{ $pengembalian->peminjaman->kepemilikan_sim ? 'Iya' : 'Tidak' }}" disabled>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    @php
                        ...
                        if (!$catatan) {
                            if ($status === 'Diproses') {
                                $catatan = 'Mohon ditunggu, pengajuan pengembalian Anda sedang diproses.';
                            } elseif ($status === 'Disetujui') {
                                $catatan = 'Pengajuan Pengembalian Anda sudah disetujui.';
                            } elseif ($status === 'Ditolak') {
                                $catatan = 'Pengajuan Pengembalian Anda ditolak.';
                            } elseif ($status === 'Selesai') {
                                $catatan = 'Pengajuan Pengembalian Anda sudah selesai';
                            }
                        }
                    @endphp
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                @elseif($pengembalian->status === 'Ditolak')
                    <a href="{{ route('pegawai.dashboard.index') }}" class="btn btn-primary">Kembali</a>
                    <a href="{{ route('pegawai.pengembalian.index', $pengembalian->peminjaman_id) }}"
                        class="btn btn-danger">Ulangi</a>
